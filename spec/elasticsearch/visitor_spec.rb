RSpec.describe Luqum::Elasticsearch::Visitor::ElasticsearchQueryBuilder do
  ...
  def fuzzy(expr, degree: nil, **kwargs)
    Luqum::Tree::Fuzzy.new(expr, degree: degree, **kwargs)
  end

  def proximity(expr, degree: nil, **kwargs)
    Luqum::Tree::Proximity.new(expr, degree: degree, **kwargs)
  end

  def range(low:, high:, include_low:, include_high:, **kwargs)
    Luqum::Tree::Range.new(low, high, include_low: include_low, include_high: include_high, **kwargs)
  end
